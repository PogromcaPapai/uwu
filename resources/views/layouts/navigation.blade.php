        ...
        <div class="flex justify-between h-16">
            ...
            @else
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <div>
                        <a href="{{ route('login') }}"
                            class="text-sm text-gray-700 hover:text-gray-500 underline hover:no-underline">{{ __('auth.login') }}</a>
                    </div>
                    <div>
                        <a href="{{ route('register') }}"
                            class="ml-4 text-sm text-gray-700 hover:text-gray-500 underline hover:no-underline">{{ __('auth.register') }}</a>
                    </div>
                </div>
            @endauth
