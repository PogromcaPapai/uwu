...
class Preference(Base):
    ...
    min_temp = Column(Integer, nullable=True, default=10)
    max_temp = Column(Integer, nullable=True, default=10)
    min_pressure = Column(Integer, nullable=True, default=900)
    max_pressure = Column(Integer, nullable=True, default=1100)
    sun = Column(Boolean, default=True)
    cloudy = Column(Boolean, default=True)
    light_rain = Column(Boolean, default=True)
    heavy_rain = Column(Boolean, default=True)
    snow = Column(Boolean, default=True)
